...
/** Thrown by chain-specific signers when the user rejected because the connected wallet did not
 *  match the address the caller expected. Callers commonly invalidate any cached address on this. */
