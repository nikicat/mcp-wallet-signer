        ...
        async function switchChain(chainId) {
          ...
          try {
            ...
            if (err && err.code === 4902) {
              ...
              } else throw new Error("Unknown chain ID: " + chainId);
            } else throw err;
          }
        }
          ...
          handleSignMsg: async function () {
            ...
            try {
              ...
              if (
                ...
                var typedData = {
                  types: Object.assign({ EIP712Domain: [] }, request.types),
